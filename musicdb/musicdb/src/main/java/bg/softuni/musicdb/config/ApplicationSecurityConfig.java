...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                //allow access to index, user login and registration resources to anyone
                ...
                .formLogin()
                //our login will be served by the controller with mapping /users/login
                .loginPage("/users/login")
                //the name of the user name input field in OUR login form is username (optional)
                .usernameParameter(UsernamePasswordAuthenticationFilter.SPRING_SECURITY_FORM_USERNAME_KEY)
                //the name of the user password field in OUR login form is password (optional)
                ...
                .and()
                .logout()
                //which endpoint performs logout, e.g. http://localhost8080/logout (!This should be POST request)
                .logoutUrl("/logout")
                ...
                .deleteCookies("JSESSIONID");// byeee!
    }
